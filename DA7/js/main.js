...
window.onload = function() {
	...
	bossHealth = game.add.text(850, 20, 'Boss : ' + hit , { font: '34px Arial', fill: '#fff' });

    bossHealth.anchor.setTo(0.5, 0.5);
	...
	function creatball3()
	{
		fire = game.add.sprite(1200,Math.random() * game.world.height,'fire');
		fire.scale.setTo(0.3,0.3);
		game.physics.arcade.enable(fire);
		fire.body.gravity.y = 300;
		fire.body.velocity.setTo(400, 800);
		//adds bounce 
		fire.body.bounce.setTo(1,1);
		//add the wall
		fire.body.collideWorldBounds = true;
		fire.body.onCollide = new Phaser.Signal();
		fire.body.onCollide.add(collide3, this);		
	}
	
	function collide3(sprite1, sprite2){
         fire.body.velocity.setTo(800,600);
	}
	...
	if(i == 900)
	{
	    ...
	    else if (checkOverlap(house,ball))
		{
		ball.destroy(); 
		if(health > 20)
		{
