...
window.onload = function() {
	...
	//load ultraball
      ultra = game.add.sprite(500,500,'ultra');
	...
	ball.scale.setTo(0.5,0.5);
      ...
      ball.body.velocity.setTo(800, 800);
      //adds bounce 
      ball.body.bounce.setTo(1,1);
      //add the wall
      ball.body.collideWorldBounds = true;
	//create the greatball
      great = game.add.sprite(500,500,'great');
	...
	bouncy = game.add.sprite( 0, 450, 'chicken' );	
        bouncy.scale.setTo(0.3,0.3);
	game.physics.arcade.enable(bouncy);
      bouncy.body.collideWorldBounds = true;
	bouncy.body.gravity.y = 500;
	
	//Display the text
        var style = { font: "25px Verdana", fill: "#ffff", align: "center"};
	...
	if (checkOverlap(bouncy, ball))
   
 	{
		...
		Text.text = "Noooooo!!!!! Game Over, You have been caught. \nRefresh page to try again ";
		
		bouncy.kill();
		    
	}
	else if (checkOverlap(bouncy, great))
	{
		Text.text = "Noooooo!!!!! Game Over, You have been caught. \nRefresh page to try again ";
		bouncy.kill();
	}
	else if (checkOverlap(bouncy, ultra))
	{
		Text.text = "Noooooo!!!!! Game Over, You have been caught. \nRefresh page to try again ";
		bouncy.kill();
	}	
